        ...
        <div className="flex flex-col gap-8 border border-primary bg-base-100 rounded-box w-full items-center p-4 min-[820px]:w-full">
            <div className="w-full flex flex-col gap-2">
                ...
                <div className="flex justify-between">
                    <h1 className="text-2xl self-start font-semibold min-[820px]:text-3xl">Song Title</h1>
                    <div className="relative">
                        <IconInProgress />
                    </div>
                </div>
                <h2 className="text-lg self-start ml-8 min-[820px]:ml-14 min-[820px]:text-xl">By Artist Name</h2>
            </div>
